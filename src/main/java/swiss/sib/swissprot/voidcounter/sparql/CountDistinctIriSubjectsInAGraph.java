...
final class CountDistinctIriSubjectsInAGraph extends QueryCallable<Long> {
	...
	private static final String COUNT_DISTINCT_SUBJECT_QUERY_GRAPH = Helper
			.loadSparqlQuery("count_distinct_iri_subjects_in_all_graphs");
	private static final Logger log = LoggerFactory.getLogger(CountDistinctIriSubjectsInAGraph.class);

	private final CommonVariables cv;

	public CountDistinctIriSubjectsInAGraph(CommonVariables cv) {
