...
final class CountDistinctIriSubjectsInAGraph extends QueryCallable<Long, CommonGraphVariables> {
	...
	public CountDistinctIriSubjectsInAGraph(CommonGraphVariables cv, OptimizeFor opti) {
		super(cv);
