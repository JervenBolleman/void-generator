...
public class CountDistinctIriSubjectsAndObjectsInDefaultGraphTest extends CommonTest {

	@ParameterizedTest
	@EnumSource(OptimizeFor.class)
	void empty(OptimizeFor of) throws IOException {
		var cv = createCommonVariables();
		var counter = new CountDistinctIriSubjectsAndObjectsInDefaultGraph(cv, of);
