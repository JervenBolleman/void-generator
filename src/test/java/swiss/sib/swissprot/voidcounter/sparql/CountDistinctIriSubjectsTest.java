...
class CountDistinctIriSubjectsTest {
	...
	void empty() throws IOException {
		...
		final CountDistinctIriSubjectsInDefaultGraph countDistinctIriObjectsForAllGraphs = new CountDistinctIriSubjectsInDefaultGraph(
				cv);
	...
	void one() throws IOException {
		...
		var countDistinctIriObjectsForAllGraphs = new CountDistinctIriSubjectsInDefaultGraph(cv);
		countDistinctIriObjectsForAllGraphs.call();
		...
		var count = new CountDistinctIriSubjectsInAGraph(cv);
		count.call();
