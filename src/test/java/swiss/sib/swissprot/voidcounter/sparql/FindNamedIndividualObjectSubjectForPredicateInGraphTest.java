...
public class FindNamedIndividualObjectSubjectForPredicateInGraphTest extends CommonTest {
	...
	void empty(OptimizeFor of) throws IOException {
		...
		var counter = new FindNamedIndividualObjectSubjectForPredicateInGraph(cv.with(emptyGd),pre, source, of);
